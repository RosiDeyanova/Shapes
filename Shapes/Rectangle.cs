...
namespace Shapes
{
    ...
    public class Rectangle : Shape
    {
        ...
        public Rectangle(int _pointA, int _pointB, int _pointC, int _pointD, Color _color) : base(_pointA, _pointB, _pointC, _color) 
        {
            PointD = _pointD;
        }
        ...
        {
            double p = 2 * PointA + 2 * PointD;
            return p;
        }

        public override double FindS()
        {
            double s = PointA * PointD;
            return s;
        }
